                        ...
                        <div class="d-flex flex-row align-items-center">
                            ...
                            <div class="info-card-text flex-1">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="useredit.php">
                                        <i class="fa fa-edit"></i>
                                    Edit Information</a>
                                    <a class="dropdown-item" href="usersecurity.php">
                                        <i class="fa fa-lock"></i>
                                    Security</a>
                                    <a class="dropdown-item" href="userstatus.php">
                                        <i class="fa fa-sun"></i>
                                    Set Status</a>
                                    <a class="dropdown-item" href="useravatar.php">
